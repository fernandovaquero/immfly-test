...
To build the final jar and optimize the ImmflyTest application for production, run:
...
[Doing API-First development]: https://www.jhipster.tech/documentation-archive/v8.7.2/doing-api-first-development/
